...
if __name__ == "__main__":
    ...
    for stage in ['train','val','test']:
        for phase in class_type:
            ...
            csv_path = os.path.join(root_path,"roi1588_%s_backup.csv"%phase)

            csv = pd.read_csv(csv_path)
            csv = csv[csv['set'] == stage].reset_index()
            save_path = r"D:\project\zjx\wisdom tooth\BBN\jsons\wisdomTeeth_%s.json"%stage
